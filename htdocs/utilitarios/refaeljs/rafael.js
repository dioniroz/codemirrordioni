...
!function (a) {
  ...
  k.listeners = function (a) {
    ...
    for (e = 0, h = m.length; h > e; e++) {
      for (l = [
      ], i = 0, k = o.length; k > i; i++) for (n = o[i].n, c = [
        n[m[e]],
        n[g]
      ], d = 2; d--; ) b = c[d],
      b && (l.push(b), p = p.concat(b.f || [
      ]));
      o = l
    }
    return p
  ...
  k.on = function (a, b) {
    ...
    for (var c = a.split(f), d = j, e = 0, g = c.length; g > e; e++) d = d.n,
    d = d.hasOwnProperty(c[e]) && d[c[e]] || (d[c[e]] = {
      n: {
      }
    });
    for (d.f = d.f || [
    ], e = 0, g = d.f.length; g > e; e++) if (d.f[e] == b) return h;
    return d.f.push(b),
    function (a) {
      + a == + a && (b.zIndex = + a)
    }
  ...
  k.f = function (a) {
    ...
    return function () {
      k.apply(null, [
        a,
        null
      ].concat(b).concat([].slice.call(arguments, 0)))
    }
  },
  k.stop = function () {
    c = 1
  ...
  k.off = k.unbind = function (a, b) {
    ...
    for (i = 0, l = o.length; l > i; i++) for (m = 0; m < p.length; m += h.length - 2) {
      if (h = [
        m,
        1
      ], c = p[m].n, o[i] != g) c[o[i]] && h.push(c[o[i]]);
...
function (a, b) {
  ...
  function f(a, b, c) {
    function d() {
      ...
      return h[z](g) ? (e(i, g), c ? c(h[g])  : h[g])  : (i.length >= 1000 && delete h[i.shift()], i.push(g), h[g] = a[D](b, f), c ? c(h[g])  : h[g])
    }
    return d
  }
  function g() {
  ...
  function k(a, b, c, d, e, f, g, h, i) {
    if (!(0 > i || j(a, b, c, d, e, f, g, h) < i)) {
      ...
      n = l - m,
      o = 0.01;
      for (k = j(a, b, c, d, e, f, g, h, n); Q(k - i) > o; ) m /= 2,
      n += (i > k ? 1 : - 1) * m,
  ...
  function m(a, b, d) {
    ...
    for (var g = j.apply(0, a), h = j.apply(0, b), i = O(~~(g / 5), 1), k = O(~~(h / 5), 1), m = [
    ], n = [
    ], o = {
    }, p = d ? 0 : [
    ], q = 0; i + 1 > q; q++) {
    ...
    for (q = 0; k + 1 > q; q++) r = c.findDotsAtSegment.apply(c, b.concat(q / k)),
    n.push({
      x: r.x,
      y: r.y,
      t: q / k
  ...
  function n(a, b, d) {
    a = c._path2curve(a),
    b = c._path2curve(b);
    for (var e, f, g, h, i, j, k, l, n, o, p = d ? 0 : [
    ], q = 0, r = a.length; r > q; q++) {
      var s = a[q];
      if ('M' == s[0]) e = i = s[1],
      f = j = s[2];
       else {
        ...
        for (var t = 0, u = b.length; u > t; t++) {
          ...
          h = l = v[2];
            ...
            if (d) p += w;
              ...
              for (var x = 0, y = w.length; y > x; x++) w[x].segment1 = q,
              w[x].segment2 = t,
              w[x].bez1 = n,
              w[x].bez2 = o;
              p = p.concat(w)
  ...
  function q(a, b, c, d, e, f) {
    ...
    function i(a, b) {
      ...
      for (e = a, i = 0; 8 > i; i++) {
        ...
        if (h = (3 * l * e + 2 * k) * e + j, Q(h) < 0.000001) break;
        e -= f / h
      }
      ...
      j.start = new Date - j.ms * f;
        ...
        for (var y in i) if (i[z](y) && (db[z](y) || d.paper.customAttributes[z](y))) switch (r[y] = d.attr(y), null == r[y] && (r[y] = cb[y]), s[y] = i[y], db[y]) {
          ...
          case 'transform':
            var G = d._,
            H = Pb(G[y], s[y]);
            if (H) for (r[y] = H.from, s[y] = H.to, t[y] = [
            ], t[y].real = !0, v = 0, x = r[y].length; x > v; v++) for (t[y][v] = [
              r[y][v][0]
            ], D = 1, F = r[y][v].length; F > D; D++) t[y][v][D] = (s[y][v][D] - r[y][v][D]) / p;
             else {
          ...
          case 'csv':
            var M = I(i[y]) [J](w),
            N = I(r[y]) [J](w);
            if ('clip-rect' == y) for (r[y] = N, t[y] = [
            ], v = N.length; v--; ) t[y][v] = (M[v] - r[y][v]) / p;
            s[y] = M;
            break;
          default:
            for (M = [
            ...
            ], v = d.paper.customAttributes[y].length; v--; ) t[y][v] = ((M[v] || 0) - (N[v] || 0)) / p
        }
        var O = i.easing,
...
c.getColor = function (a) {
  ...
  return b.h += 0.075,
  b.h > 1 && (b.h = 0, b.s -= 0.2, b.s <= 0 && (this.getColor.start = {
    h: 0,
    s: 1,
    b: b.b
  })),
...
var Bb = c.pathBBox = function (a) {
  ...
  ], i = 0, j = a.length; j > i; i++) if (c = a[i], 'M' == c[0]) e = c[1],
  f = c[2],
  g.push(e),
  h.push(f);
   else {
...
Db = c._pathToRelative = function (a) {
  ...
  h = 0,
  i = 0;
  'M' == a[0][0] && (e = a[0][1], f = a[0][2], g = e, h = f, i++, d.push(['M',
  e,
  f]));
...
if (c.is(a, V) && c.is(a && a[0], V) || (a = c.parsePathString(a)), !a || !a.length) return [['M',
0,
0]];
var d = [
],
...
if (d.push(k = [
]), l = a[n], l[0] != bb.call(l[0])) switch (k[0] = bb.call(l[0]), k[0]) {
  case 'A':
    k[1] = l[1],
    k[2] = l[2],
    k[3] = l[3],
  ...
  case 'R':
    for (var p = [
      e,
      f
    ][E](l.slice(1)), q = 2, r = p.length; r > q; q++) p[q] = + p[q] + e,
    p[++q] = + p[q] + f;
    d.pop(),
    d = d[E](h(p, m));
    break;
...
if (P[0] = 2 * O[0] - P[0], P[1] = 2 * O[1] - P[1], k) return [P,
R,
T][E](o);
o = [
P,
...
for (var U = [
], V = 0, W = o.length; W > V; V++) U[V] = V % 2 ? p(o[V - 1], o[V], n).y : p(o[V], o[V + 1], n).x;
return U
},
...
return Q(m) > '1e12' && (m = 0.5),
Q(n) > '1e12' && (n = 0.5),
m > 0 && 1 > m && (i = Ib(a, b, c, d, e, f, g, h, m), p.push(i.x), o.push(i.y)),
n > 0 && 1 > n && (i = Ib(a, b, c, d, e, f, g, h, n), p.push(i.x), o.push(i.y)),
j = f - 2 * d + b - (h - 2 * f + d),
k = 2 * (d - b) - 2 * (f - d),
l = b - d,
m = ( - k + N.sqrt(k * k - 4 * j * l)) / 2 / j,
...
f.x,
f.y
]), c.bx = 0, c.by = 0, c.x = a[g][1], c.y = a[g][2], l = O(d.length, e && e.length || 0))
...
k = new o;
if (j.transform = d || [
], d) for (var l = 0, m = d.length; m > l; l++) {
var n,
p,
q,
r,
...
a.toString = function () {
return c.svg ? 'matrix(' + [this.get(0),
this.get(1),
this.get(2),
this.get(3),
this.get(4),
...
var b = a || this[J]();
return b.isSimple ? (b.scalex = + b.scalex.toFixed(4), b.scaley = + b.scaley.toFixed(4), b.rotate = + b.rotate.toFixed(4), (b.dx || b.dy ? 't' + [b.dx,
b.dy] : G) + (1 != b.scalex || 1 != b.scaley ? 's' + [b.scalex,
b.scaley,
0,
0] : G) + (b.rotate ? 'r' + [b.rotate,
0,
0] : G))  : 'm' + [this.get(0),
this.get(1),
this.get(2),
...
for (var d, e = Xb.length; e--; ) d = Xb[e],
d.el._drag = {
},
...
if (this.getTotalLength(a) - c < 0.000001) return gc(a, b).end;
var d = gc(a, c, 1);
...
if ('text' != this.type && 'set' != this.type) return b && (a = b(this)),
a
},
...
elastic: function (a) {
return a == !!a ? a : R(2, - 10 * a) * N.sin(2 * (a - 0.075) * S / 0.3) + 1
},
bounce: function (a) {
var b,
c = 7.5625,
d = 2.75;
return 1 / d > a ? b = c * a * a : 2 / d > a ? (a -= 1.5 / d, b = c * a * a + 0.75)  : 2.5 / d > a ? (a -= 2.25 / d, b = c * a * a + 0.9375)  : (a -= 2.625 / d, b = c * a * a + 0.984375),
b
}
};
  ...
  for (var r in k) if (k[z](r)) {
    switch (db[r]) {
      case T:
        ...
        break;
      case 'colour':
        f = 'rgb(' + [lc($(k[r].r + q * i * l[r].r)),
        lc($(k[r].g + q * i * l[r].g)),
        lc($(k[r].b + q * i * l[r].b))].join(',') + ')';
        break;
      case 'path':
        f = [
        ];
      ...
      case 'transform':
        if (l[r].real) for (f = [
        ], t = 0, u = k[r].length; u > t; t++) for (f[t] = [
          k[r][t][0]
        ], v = 1, w = k[r][t].length; w > v; v++) f[t][v] = k[r][t][v] + q * i * l[r][t][v];
         else {
          var x = function (a) {
        ...
        break;
      case 'csv':
        if ('clip-rect' == r) for (f = [
        ], t = 4; t--; ) f[t] = + k[r][t] + q * i * l[r][t];
        break;
      default:
        var y = [
        ][E](k[r]);
        for (f = [
        ], t = n.paper.customAttributes[r].length; t--; ) f[t] = + y[t] + q * i * l[r][t]
    }
    o[r] = f
  }
  n.attr(o),
...
f = 0;
if (null != b) return s(a, this, - 1, P(b, 1)),
this;
...
var mc = function (a) {
if (this.items = [
], this.length = 0, this.type = 'set', a) for (var b = 0, c = a.length; c > b; b++) !a[b] || a[b].constructor != $b.constructor && a[b].constructor != mc || (this[this.items.length] = this.items[this.items.length] = a[b], this.length++)
},
nc = mc.prototype;
nc.push = function () {
for (var a, b, c = 0, d = arguments.length; d > c; c++) a = arguments[c],
!a || a.constructor != $b.constructor && a.constructor != mc || (b = this.items.length, this[b] = this.items[b] = a, this.length++);
return this
},
nc.pop = function () {
...
], e = this.items.length; e--; ) if (!this.items[e].removed) {
...
} else d = c._g.doc.createElementNS('http://www.w3.org/2000/svg', d),
...
if (!s) {
  if (e = b(e).replace(c._radial_gradient, function (a, b, c) {
    if (j = 'radial', b && c) {
      ...
      n = d(c);
      var e = 2 * (n > 0.5) - 1;
      i(m - 0.5, 2) + i(n - 0.5, 2) > 0.25 && (n = f.sqrt(0.25 - i(m - 0.5, 2)) * e + 0.5) && 0.5 != n && (n = n.toFixed(5) - 0.00001 * e)
    }
    return l
...
if ('path' == d.type) {
  ...
  if ('open' == w ? (x += 2, y += 2, z += 2, i = 1, j = f ? 4 : 1, k = {
    ...
    }), D.appendChild(C), n.defs.appendChild(D), p[B] = 1),
    q(C, k);
    var E = i * ('diamond' != w && 'oval' != w);
    f ? (g = d._.arrows.startdx * u || 0, h = c.getTotalLength(t.path) - E * u)  : (g = E * u, h = c.getTotalLength(t.path) - (d._.arrows.enddx * u || 0)),
    k = {
    },
    k['marker-' + r] = 'url(#' + B + ')',
...
} else f ? (g = d._.arrows.startdx * u || 0, h = c.getTotalLength(t.path) - g)  : (g = 0, h = c.getTotalLength(t.path) - (d._.arrows.enddx * u || 0)),
...
], n = 0, o = k.length; o > n; n++) j = q('tspan'),
n && q(j, {
  dy: i * x,
  x: g.x
}),
...
return this.transform(this._.transform.concat([['r',
a,
c,
e]])),
this
...
return this.removed ? this : (a = b(a).split(j), a.length - 1 && (c = d(a[1])), a = d(a[0]) || 0, c = + c || 0, this.transform(this._.transform.concat([['t',
a,
c]])), this)
},
...
for (var g = b.split(j), h = {
}, i = 0, l = g.length; l > i; i++) b = g[i],
...
for (h = {
}, i = 0, l = b.length; l > i; i++) h[b[i]] = this.attr(b[i]);
return h
}
if (null != d) {
var m = {
...
1 == b ? (i.style.cssText = j + 'position:absolute;left:' + d + 'px;top:' + e + 'px', c._g.doc.body.appendChild(i), h = 1)  : (i.style.cssText = j + 'position:relative', b.firstChild ? b.insertBefore(i, b.firstChild)  : b.appendChild(i)),
b = new c._Paper,
b.width = f,
b.height = g,
b.canvas = i,
...
if (q && (m.path = c._getPath[e.type](e), e._.dirty = 1), i.href && (l.href = i.href), i.title && (l.title = i.title), i.target && (l.target = i.target), i.cursor && (p.cursor = i.cursor), 'blur' in i && e.blur(i.blur), (i.path && 'path' == e.type || q) && (l.path = x(~b(m.path).toLowerCase().indexOf('r') ? c._pathToAbsolute(m.path)  : m.path), 'image' == e.type && (e._.fillpos = [
m.x,
m.y
], e._.fillsize = [
m.width,
...
} else K.color = c.getRGB(i.fill).hex,
K.src = o,
K.type = 'solid',
...
return i = 'radial',
b && c && (b = d(b), c = d(c), h(b - 0.5, 2) + h(c - 0.5, 2) > 0.25 && (c = e.sqrt(0.25 - h(b - 0.5, 2)) * (2 * (c > 0.5) - 1) + 0.5), j = b + n + c),
o
...
for (var m = [
], p = 0, q = l.length; q > p; p++) l[p].offset && m.push(l[p].offset + n + l[p].color);
...
return this.removed ? this : (a = b(a).split(k), a.length - 1 && (c = d(a[1])), a = d(a[0]) || 0, c = + c || 0, this._.bbox && (this._.bbox.x += a, this._.bbox.y += c), this.transform(this._.transform.concat([['t',
a,
c]])), this)
},
...
for (var g = b.split(k), h = {
}, i = 0, m = g.length; m > i; i++) b = g[i],
h[b] = b in this.attrs ? this.attrs[b] : c.is(this.paper.customAttributes[b], 'function') ? this.paper.customAttributes[b].def : c._availableAttrs[b];
return m - 1 ? h : h[g[0]]
}
if (this.attrs && null == d && c.is(b, 'array')) {
for (h = {
}, i = 0, m = b.length; m > i; i++) h[b[i]] = this.attr(b[i]);
return h
}
var n;
null != d && (n = {
...
0 !== + a ? (this.attrs.blur = a, b.filter = d + n + m + '.Blur(pixelradius=' + ( + a || 1.5) + ')', b.margin = c.format('-{0}px 0 0 -{0}px', f( + a || 1.5)))  : (b.filter = d, b.margin = 0, delete this.attrs.blur),
this
},
c._engine.path = function (a, b) {
var c = F('shape');
...
k = this.height,
l = 1 / g(d / j, e / k);
return f && (h = k / e, i = j / d, j > d * h && (a -= (j - d * h) / 2 / h), k > e * i && (b -= (k - e * i) / 2 / i)),
this._viewBox = [
a,
b,
d,
