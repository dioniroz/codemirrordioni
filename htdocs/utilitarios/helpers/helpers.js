...
function inscomponente(componente,nombrecomponente="todoparatodos"){

  let cp = null;
  let j = {"nombrecomponente":nombrecomponente}
  ajax.POST(componente,j).then(function(response){
...
// function cargarpropertis(){

//   if(typeof Object.obtenerproperties=='function'){
//     return
//   }else{
//     Object.prototype.obtenerproperties = function() {

//   var result = [];
//   let este = this;
//   for (var property in este){
//     if (este.hasOwnProperty(property)){
...
// // get: function() {return this.obtenerproperties() }

// // });
//   }
// return 'ahora sirve cargarpropertis';
// }
op=function obtenerproperties(objeto=window){
  var result = [];
